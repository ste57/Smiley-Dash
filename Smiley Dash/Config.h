...
#define level2bouncers 15
#define level3bouncers 25
...
#define timeNumber 2
#define starNumber 3
#define heartNumber 4
#define coinNumber 5
#define explodeNumber 10
#define heroTag 1
#define superHeroTag 2
